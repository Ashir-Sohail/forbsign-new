...
class OptionController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.option.index')->with('success', 'Option and its values added successfully!');
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin.option.update', compact('option', 'InputType'));
    }
    ...
    public function delete($id): RedirectResponse
    {
        ...
        // }
        $option->delete();
        return redirect()->route('admin.option.index')->with('success', 'Option Delete successfully');
    }
    ...
    public function update_status($id): RedirectResponse
    {
        ...
        if ($option->status == 1) {
            ...
            return redirect()->route('admin.option.index')->with('success', 'Option Status un-active successfully');
        } else {
            $option->status = 1;
            $option->save();

            return redirect()->route('admin.option.index')->with('success', 'Option Status active successfully');
        }
    }
}
