                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class=" mb-0 "><b>Subscriber List</b></h3>
                        </div>
                    </div>
                </div>
                                            ...
                                            <td>
                                                <div class="action-list">
                                                    ...
                                                    <a class="btn btn-danger btn-sm " data-toggle="modal"
                                                        ...
                                                        data-href="{{ route('client.subscribers.delete', ['id'=>$subscriber->id]) }}">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        You are going to delete this Subscriber. All contents related with this admin will be lost. Do you want
                        to delete it?
                    </div>
