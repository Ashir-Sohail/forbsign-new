                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown">
                                                    <button class="btn btn-success btn-sm  dropdown-toggle" type="button"
                                                        ...
                                                        aria-expanded="false">
                                                        {{ $product->status == 1 ? 'Publish' : 'Unpublish' }}
                                                    </button>
                                                    <div class="dropdown-menu animated--fade-in"
                                                        aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item"
                                                            href="{{ route('client.product.change.status', ['id' => $product->id]) }}">Publish</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('client.product.change.status', ['id' => $product->id]) }}">Unpublish</a>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu animated--fade-in"
                                                        aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item"
                                                            href="{{ route('client.product.edit', ['id' => $product->id]) }}"><i
                                                                class="fas fa-angle-double-right"></i> Edit</a>
                                                        {{-- <a class="dropdown-item" target="_blank"
                                                            href="{{ route('client.product.edit', ['id'=>$product->id]) }}"><i
                                                                class="fas fa-angle-double-right"></i> View</a> --}}
                                                        <a class="dropdown-item"
                                                            href="{{ route('client.product.edit', ['id' => $product->id]) }}?view=1"
                                                            target="_blank">
                                                        ...
                                                        <a class="dropdown-item" data-toggle="modal"
                                                            ...
                                                            data-href="{{ route('client.product.delete', ['id' => $product->id]) }}"><i
