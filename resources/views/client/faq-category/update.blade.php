                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title"><b>Update Faq Category</b> </h3>
                            <a class="btn btn-primary btn-sm" href="{{ route('client.faq-category.index') }}"><i
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-12">
                                        <form class="admin-form"
                                            action="{{ route('client.faq-category.update', ['id' => $faq_category->id]) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="text" id="text" class="form-control" rows="5" placeholder="Enter Description">{{ $faq_category->text }}</textarea>
                                                @error('text')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                                ...
                                                <select name="website_id" id="website_id" class="form-control">
                                                    ...
                                                    @foreach ($website as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ old('website_id', $faq_category->website_id) == $item->id ? 'selected' : '' }}>
                                                            {{ $item->domain_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="meta_description" id="meta_description" class="form-control" rows="5"
                                                    placeholder="Enter Meta Description">{{ $faq_category->meta_description }}</textarea>
