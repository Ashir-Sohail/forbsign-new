                        ...
                        <div class="card o-hidden border-0 shadow-lg">
                            <div class="card-body ">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-12">
                                        <form class="admin-form" action="{{ route('client.faq-category.store') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="text" id="text" class="form-control" rows="5" placeholder="Enter Description"></textarea>
                                                @error('text')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
