                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-12">
                                        <form class="admin-form"
                                            action="{{ route('client.brand.update', ['id' => $brand->id]) }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br>
                                                @if ($brand->image)
                                                    {{-- <img class="admin-img" src="{{ \App\Helpers\FileUploadHelper::url($brand->image }}"
                                                        alt="{{ $brand->name }}"> --}}
                                                    <img class="admin-img"
                                                ...
                                                <select name="website_id" id="website_id" class="form-control">
                                                    ...
                                                    @foreach ($website as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ old('website_id',$brand->website_id) == $item->id ? 'selected' : '' }}>
                                                            {{ $item->domain_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
