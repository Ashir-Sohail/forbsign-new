            ...
            <div class="container-fluid">
                ...
                <div class="card mb-4">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('client.dashboard') }}">Dashboard</a>
                            </li>
                        ...
                        <div class="card o-hidden border-0 shadow-lg">
                            <div class="card-body ">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col">
                                        <div class="p-5">
                                            <form class="admin-form" action="{{ route('client.update.profile') }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="city" class="form-control" id="city"
                                                        placeholder="city"
                                                        value="{{ Auth::guard('client')->user()->city }}">
                                                    @error('city')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
