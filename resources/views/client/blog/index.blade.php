                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="right">
                                <a class="btn btn-primary  btn-sm" href="{{ route('client.blog.create') }}"><i
                                            ...
                                            <td>
                                                <div class="action-list">
                                                    <a class="btn btn-secondary btn-sm "
                                                        href="{{ route('client.blog.edit', ['id' => $blog->id]) }}">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a class="btn btn-danger btn-sm " data-toggle="modal"
                                                        data-target="#confirm-delete" href="javascript:;"
                                                        data-href="{{ route('client.blog.delete', ['id' => $blog->id]) }}">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            You are going to delete this blog. All contents related with
                                                            this blog will be lost. Do you want
                                                            to delete it?
                                                        </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form
                                                                action="{{ route('client.blog.delete', ['id' => $blog->id]) }}"
