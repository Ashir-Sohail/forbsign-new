                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title"><b>Blog Categories</b></h3>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu animated--fade-in"
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.blog-category.change.status', ['id' => $category->id]) }}">Enable</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.blog-category.change.status', ['id' => $category->id]) }}">Disable</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            You are going to delete this blog category. All contents related with
                                                            this blog category will be lost. Do you want
                                                            to delete it?
                                                        </div>
