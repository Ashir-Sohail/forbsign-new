                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title"><b>About Preferences</b></h3>
                        ...
                        <div class="card o-hidden border-0 shadow-lg mb-4">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs" id="preferencesTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#about" role="tab">About
                                            Section</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <!-- Form Start -->
                                <form action="{{ route('admin.about.store.preferences') }}" method="POST">
                                    @csrf
                                    <div class="tab-content pt-4">
                                        ...
                                        <div class="tab-pane fade show active" id="about" role="tabpanel">
                                            <div class="form-group">
                                                <label for="about_title">Title<span class="req-star">*</span></label>
                                                <input type="text" name="about_title" class="form-control"
                                                    id="about_title"
                                                    value="{{ old('about_title', $aboutpreferences['about_title'] ?? '') }}"
                                                    required>
                                            </div>
                                            @error('about_title')
                                            ...
                                            @enderror
                                            <div class="form-group">
                                                <label for="about_heading">Heading<span class="req-star">*</span></label>
                                                <input type="text" name="about_heading" class="form-control"
                                                    id="about_heading"
                                                    value="{{ old('about_heading', $aboutpreferences['about_heading'] ?? '') }}"
                                                    required>
                                            </div>
                                            @error('about_heading')
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="tab-pane fade" id="information" role="tabpanel">
                                            <div class="form-group">
                                                ...
                                                <textarea name="information_icon1" class="form-control" id="information_icon1" required>{{ old('information_icon1', $aboutpreferences['information_icon1'] ?? '') }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="information_heading1" class="form-control"
                                                    ...
                                                    value="{{ old('information_heading1', $aboutpreferences['information_heading1'] ?? '') }}"
                                                    required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="information_description1" class="form-control" id="information_description1" required>{{ old('information_description1', $aboutpreferences['information_description1'] ?? '') }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="information_icon2" class="form-control" id="information_icon2" required>{{ old('information_icon2', $aboutpreferences['information_icon2'] ?? '') }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="information_heading2" class="form-control"
                                                    ...
                                                    value="{{ old('information_heading2', $aboutpreferences['information_heading2'] ?? '') }}"
                                                    required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="information_description2" class="form-control" id="information_description2" required>{{ old('information_description2', $aboutpreferences['information_description2'] ?? '') }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="information_icon3" class="form-control" id="information_icon3" required>{{ old('information_icon3', $aboutpreferences['information_icon3'] ?? '') }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="information_heading3" class="form-control"
                                                    ...
                                                    value="{{ old('information_heading3', $aboutpreferences['information_heading3'] ?? '') }}"
                                                    required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="information_Description3" class="form-control" id="information_Description3"
                                                    required>{{ old('information_Description3', $aboutpreferences['information_Description3'] ?? '') }}</textarea>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="customer" role="tabpanel">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="customer_heading" class="form-control"
                                                    id="customer_heading"
                                                    value="{{ old('customer_heading', $aboutpreferences['customer_heading'] ?? '') }}"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
