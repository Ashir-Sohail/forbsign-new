                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu animated--fade-in"
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.order.change.status', ['id' => $order->id, 'status' => 'paid']) }}">Paid</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.order.change.status', ['id' => $order->id, 'status' => 'unpaid']) }}">Unpaid</a>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu animated--fade-in"
                                                        ...
                                                        <a class="dropdown-item" data-toggle="modal"
                                                            data-target="#statusModal" href="javascript:;"
                                                            data-href="{{ route('admin.order.change.processing.status', ['id' => $order->id]) }}">Processing</a>
                                                        <a class="dropdown-item" data-toggle="modal"
                                                            data-target="#statusModal" href="javascript:;"
                                                            data-href="{{ route('admin.order.change.progress.status', ['id' => $order->id]) }}">
                                                            Progress</a>
                                                        <a class="dropdown-item" data-toggle="modal"
                                                            data-target="#statusModal" href="javascript:;"
