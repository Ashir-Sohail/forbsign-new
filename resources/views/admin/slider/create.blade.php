                                                ...
                                                <form action="{{ route('admin.slider.store') }}" method="POST"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="url" class="form-control"
                                                            id="slider-link" placeholder="Enter Valid Link Or Url" value="{{ old('url') }}">
                                                        @error('url')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="details" id="details" class="form-control" rows="5" placeholder="Enter Details">{{ old('details') }}</textarea>
                                                        @error('details')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
