...
@section('content')
    @php
        $basic_value = $basic_setting ? json_decode($basic_setting->value) : null;
        $home_page_value = $home_page_setting ? json_decode($home_page_setting->value) : null;
        $first_three_column_value = $first_three_column ? json_decode($first_three_column->value) : null;
        $second_three_column_value = $second_three_column ? json_decode($second_three_column->value) : null;
        $four_three_column_value = $four_three_column ? json_decode($four_three_column->value) : null;
        $third_two_column_value = $third_two_column ? json_decode($third_two_column->value) : null;
        $media_value = $media_setting ? json_decode($media_setting->value) : null;
        $seo_value = $seo_setting ? json_decode($seo_setting->value) : null;
                                                        ...
                                                        <div id="herosectionbanner" class="tab-pane"><br>
                                                            <form action="{{ route('admin.manage-site.home_page') }}"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    @else
                                                                        <img class="admin-setting-img"
                                                                            src="{{ asset('assets/imgs/dummy-img.png') }}"
                                                                            alt="No Image Found"
                                                                    ...
                                                                    {{-- <input type="file" name="image1" id="image1"
                                                                        ...
                                                                        {{ empty($home_page_value->image1) ? 'required' : '' }}> --}}

                                                                    <span class="mt-1">Image Size Should Be 714 x
                                                                        541.</span>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="sub_title1"
                                                                        class="form-control" id="sub_title1" required
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="sub_title2"
                                                                        class="form-control" id="sub_title2" required
                                                                                ...
                                                                                <div class="row justify-content-center">
                                                                                    ...
                                                                                    <div class="col-lg-12">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <br>
                                                                                            <span class="mt-1">Image Size
                                                                                                Should Be 1116 x 441.</span>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="text"
                                                                                                ...
                                                                                                class="form-control"
                                                                                                id="google_maps_url"
                                                                                                placeholder="Google Maps Address URL"
                                                                                                value="{{ $footer_value->google_maps_url ?? '' }}">
                                                                                        </div>
