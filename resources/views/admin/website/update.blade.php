                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title"><b>Update Website</b></h3>
                                        ...
                                        <form action="{{ route('admin.website.update', $website->id) }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="domain_name" class="form-control"
                                                    id="domain_name"
                                                    value="{{ old('domain_name', $website->domain_name) }}">
                                                @error('domain_name')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="seo_url" class="form-control" id="seo_url"
                                                    value="{{ old('seo_url', $website->seo_url) }}">
                                                @error('seo_url')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="form-control" id="description" rows="4">{{ old('description', $website->description) }}</textarea>
                                                @error('description')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                                ...
                                                <select name="client_id" class="form-control" id="client_id">
                                                    ...
                                                    @foreach ($clients as $client)
                                                        <option value="{{ $client->id }}"
                                                            {{ old('client_id', $website->client_id) == $client->id ? 'selected' : '' }}>
                                                            {{ $client->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                <label for="web_icon">Change Web Icon (optional)</label>
                                            ...
                                            {{-- <div class="form-group">
                                                ...
                                                <select name="status" class="form-control" id="status">
                                                    <option value="1"
                                                        {{ old('status', $website->status) == 1 ? 'selected' : '' }}>Active
                                                    </option>
                                                    <option value="0"
                                                        {{ old('status', $website->status) == 0 ? 'selected' : '' }}>
                                                        Inactive</option>
                                                </select>
                                                @error('status')
                                                    <span class="text-danger">{{ $message }}</span>
