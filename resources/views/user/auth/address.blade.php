            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row" action="{{ route('user.address.update') }}" method="POST"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="company" value="{{ $address->company ?? '' }}"
                                        type="text" id="account-pass">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="contact">Contact</label>
                                    <input class="form-control" name="contact" value="{{ $address->contact ?? '' }}"
