                        ...
                        <form action="{{ route('user.password.update') }}" method="POST">
                            ...
                            <div class="col-12 my-4">
                                <div class="form-floating">
                                    <input type="password" class="form-control" id="oldPassward" placeholder="Old Passward"
                                        name="oldPassword">
                            ...
                            <div class="col-12 my-4">
                                <div class="form-floating">
                                    <input type="password" class="form-control" id="newPassword" placeholder="newPassword"
                                        name="newPassword">
                                    <label for="newPassword ">New Passward</label>
                                </div>
                                @error('newPassword')
                                    <p class="text-danger text-start">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="col-12 my-4">
                                <div class="form-floating">
                                    <input type="password" class="form-control" id="conPassword"
                                        placeholder="Confirm Passwaod" name="newPassword_confirmation">
                                    <label for="newPassword_confirmation">Confirm Password</label>
                                </div>

                            </div>
                            <div class="col-12">
                                <button type="submit" class="btn primary_btn w-100 rounded-0">Update Password</button>
                            </div>
                        </form>
                    </div>
                </div>
